-- Archives « Pas cette fois » — coller TOUT ce fichier dans l’éditeur SQL Supabase, puis Run.
-- Recrée la table, les politiques RLS, et la fonction dismiss_declined_notification
-- (signature exacte attendue par le site : p_id, p_archive, p_origin).

-- Couronne Matcher : persiste decision=match + like renvoyé, renvoie matched_at.
-- Coller TOUT ce fichier dans Supabase → SQL Editor, puis Run.
-- Même fonction que supabase/migrations/20260912120000_crown_match_persist_matched_at.sql.

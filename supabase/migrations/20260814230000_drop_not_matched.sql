-- Supprime définitivement RAISE not_matched.
-- Accès conversation dès qu’une relation existe (like ou flash, n’importe quel sens).
-- users_are_matched ne dépend plus d’un like bidirectionnel ni de match_bonds.

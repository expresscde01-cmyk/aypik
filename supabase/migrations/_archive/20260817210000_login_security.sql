-- ARCHIVÉ le 2026-09-10 : jamais tracké dans schema_migrations (appliqué historiquement via SQL Editor). Contient des GRANT EXECUTE ... TO anon, authenticated sur record_login_failure/login_security_status qui rouvriraient la faille corrigée le 2026-09-10. Remplacé par 20260910130233_reconcile_login_security_initial_setup.sql (table + fonctions non concernées) et 20260910120544_revoke_preauth_account_oracles.sql (droits corrects). Ne pas rejouer tel quel.

...
BEGIN
  ...
  -- Garde-fou serveur : options payantes Pays francophone / International.
  -- Le grisage frontend est la protection principale, ceci évite un
  -- contournement en appelant directement le RPC.
  IF (v_international AND NOT public.has_addon_access(me, 'international'))
     OR (v_french_world AND NOT public.has_addon_access(me, 'francophone')) THEN
    RETURN;
  END IF;

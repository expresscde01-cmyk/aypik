-- Accueil (suggest_profiles) : shortlist d’affinité, pas le catalogue Découvrir.
-- Qualifier : même ville OU même département OU même région OU ≥1 intérêt commun.
-- Région voisine reste un bonus de score + badge, pas un ticket d’entrée seul.

...
function FreemiumActiveBanner() {
  return (
    <div className="relative overflow-hidden rounded-3xl border-2 border-sky-200 bg-gradient-to-br from-sky-400 via-sky-300 to-amber-200 shadow-lg shadow-sky-200/50">
      <div
        className="pointer-events-none absolute inset-0 opacity-55"
        style={{
          backgroundImage:
            'radial-gradient(circle at 88% 18%, rgba(255,236,179,0.95) 0%, rgba(251,191,36,0.35) 22%, transparent 52%), radial-gradient(circle at 12% 78%, rgba(255,255,255,0.55) 0%, transparent 45%), radial-gradient(circle at 40% 10%, rgba(186,230,253,0.7) 0%, transparent 40%)',
        }}
      />
      <div className="relative p-5 sm:p-6 space-y-4">
        <div className="flex flex-wrap items-center gap-2">

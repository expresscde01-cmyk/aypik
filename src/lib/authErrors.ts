...
const CODE_MESSAGES: Record<string, string> = {
  ...
  over_email_send_rate_limit:
    "Trop d'e-mails envoyés. Veuillez réessayer plus tard.",
...
const MESSAGE_PATTERNS: [RegExp, string][] = [
  ...
  [/email.*confirm/i, 'Veuillez confirmer votre adresse e-mail.'],
  [/unable to validate email/i, 'Adresse e-mail invalide.'],
  [/signup requires a valid password/i, 'Veuillez saisir un mot de passe valide.'],
  [/password is known to be weak/i, 'Ce mot de passe est trop courant. Choisissez-en un autre.'],
];
...
const WEAK_PASSWORD_REASONS: Record<string, string> = {
  ...
  pwned: 'Ce mot de passe a été compromis dans une fuite de données. Choisissez-en un autre.',
};
